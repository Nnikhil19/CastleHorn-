    ...
    <div className="sub-page">
      ...
      <main className="simple-page">
        ...
        <section className="simple-section">
          ...
          <p>CastleHorn does not process payments or leases. Use the host's UT email or phone number to ask questions, tour the space, confirm details, and arrange the handoff yourself.</p>
        </section>
        <section className="simple-section">
          <h2>For subletters</h2>
          <p>Create a UT-verified account, complete your profile, then submit a listing with the full property address, monthly rent, photos, contact info, and proof of occupancy.</p>
        ...
        <section className="simple-section">
          ...
          <p>Use your UT email, verify the address, compare rent with the lease, avoid paying before seeing proof, and keep important agreements in writing.</p>
        </section>
      </main>
    </div>
  );
